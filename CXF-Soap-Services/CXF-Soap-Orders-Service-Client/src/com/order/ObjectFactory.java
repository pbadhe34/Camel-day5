...
public class ObjectFactory {
    ...
    private final static QName _Order_QNAME = new QName("http://order.com/", "order");
    private final static QName _OrderResponse_QNAME = new QName("http://order.com/", "orderResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://order.com/", name = "order")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://order.com/", name = "orderResponse")
